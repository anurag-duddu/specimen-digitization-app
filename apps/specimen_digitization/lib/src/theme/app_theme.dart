...
abstract final class AppTheme {
  ...
  static ThemeData _build({
    ...
    return ThemeData(
      ...
      inputDecorationTheme: specimenInputTheme(scheme),
      filledButtonTheme: specimenFilledButtonTheme(),
      outlinedButtonTheme: specimenOutlinedButtonTheme(scheme),
      textButtonTheme: specimenTextButtonTheme(),
      iconButtonTheme: specimenIconButtonTheme(),
      chipTheme: specimenChipTheme(scheme),
