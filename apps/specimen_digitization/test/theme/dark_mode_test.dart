...
void main() {
  ...
  // The glossary pane scrolls on its own. A term cut by the pane's edge
  // cannot be measured, and a longer glossary moves the cut, so the window
  // is tall enough to show the whole pane.
  bothThemes(
    'Help',
    () => const Scaffold(body: HelpScreen()),
    size: const Size(1024, 3600),
  );
