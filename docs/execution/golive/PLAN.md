...
project. The production model allowance is USD 5 (G30), reserved at each call's
worst-case cost and settled to its computed or billed cost; the acceptance lab's
