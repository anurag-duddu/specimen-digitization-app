...
| `HarnessInput` | each `Transcript.handoffs` entry with its handed text: the decided transcript's one with a selected reading, every reading's without (G19) |
