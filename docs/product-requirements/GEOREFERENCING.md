...
**Status:** The owner asked for the retrospective tool to be fully implemented (G34, 2026-09-24), and S8 now builds it. Its decisions D1 to D13 are proposed, not accepted by the owner (G12). The Google Maps geography tool (G10) stays in production until the owner has ruled on D1 and the acceptance lab shows that this tool resolves the pilot slides at least as well (coordinator, 2026-09-24).
...
|---|---|---|---|
| 1 | Decide D1 to D7 and D9 (D14 and D15 are decided, G27 and G34; D11 and D13 are the coordinator's engineering rulings; D8, D10 and D12 wait for their phase) | owner | decisions recorded here |
...
D1 to D13 are proposed, not accepted by the owner (G12). Each is a question with its options and, separately, S8's recommendation; the coordinator puts them to the owner, and this document records the answers before its pull request merges. D1 to D7 and D9 go to the owner, D3a and D3b as one question. D11 and D13 are engineering choices, which the coordinator ruled on 2026-09-24. D8, D10 and D12 wait for their phase, and nothing is built for them. D14 and D15 are decided: D14 on 2026-09-23 (G27), ahead of the rest because S4 was building G20, and D15 on 2026-09-24 (G34), when the owner also asked for this tool to be fully implemented.
...
| D12 | Should the project get the sources that need a token or an account? | a) Not yet: defer Getty's new gateway, a World Historical Gazetteer token and a GeoNames account (the dumps need none). b) Request them now through the owner actions. | a. Waits for its phase (coordinator, 2026-09-24); nothing is built for it | nothing in Phase 1 |
