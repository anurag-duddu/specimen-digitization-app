...
| geoBoundaries' simplified Philippine files | CC BY 3.0 IGO, per file (NAMRIA, PSA and OCHA Philippines, via HDX) [S18] | yes, credited | derived county and city (G37), the circle widened by the stated simplification error |
...
- [S18] GADM license, https://gadm.org/license.html; geoBoundaries, https://github.com/wmgeolab/geoBoundaries, with each file's license and sources in its metadata, such as https://www.geoboundaries.org/api/current/gbOpen/PHL/ADM3/; CONRED's COD-AB for Guatemala, https://data.humdata.org/dataset/cod-ab-gtm
